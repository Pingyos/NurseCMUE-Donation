...
$con = mysqli_connect("localhost", "root", "", "nurse_edo") or die("Error: " . mysqli_error($con));
...
if (isset($_POST['function']) && $_POST['function'] == 'provinces') {
    $id = $_POST['id'];
    $sql = "SELECT * FROM amphures WHERE province_id='$id' ORDER BY province_id ASC";
...
if (isset($_POST['function']) && $_POST['function'] == 'amphures') {
    $id = $_POST['id'];
    $sql = "SELECT * FROM districts WHERE amphure_id='$id'ORDER BY amphure_id ASC";
    $query = mysqli_query($con, $sql);
...
if (isset($_POST['function']) && $_POST['function'] == 'districts') {
    $id = $_POST['id'];
    $sql = "SELECT * FROM districts WHERE id='$id' ORDER BY id ASC";
